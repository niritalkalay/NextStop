...
if __name__ == '__main__':
    ...
    print ("TP : ", class_evaluator.TP)
    print ("FP : ", class_evaluator.FP)
    print ("FN : ",class_evaluator.FN)
    print ("IDswitch count:" ,class_evaluator.IDS)
    print("IDfragments count:", class_evaluator.fragments)