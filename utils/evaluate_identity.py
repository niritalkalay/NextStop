...
from eval_id import Identity
from eval_hota import HOTA
...
if __name__ == '__main__':
    ...
    class_evaluator_ID = Identity(nr_classes, None, ignore_class, min_points=FLAGS.min_inst_points)
    class_evaluator_HOTA = HOTA()
    ...
    for label_file, pred_file in zip(label_names, pred_names):
        ...
        # filter GT
        #
        #sem_ind  = np.where(u_label_sem_class==1)[0] # cars
        #inst_ind = np.where(u_label_inst[sem_ind] >>16 ==277)[0]
        # ours
