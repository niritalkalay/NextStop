...
from Xinshuo_PyToolbox_master.xinshuo_io import mkdir_if_missing
from Xinshuo_PyToolbox_master.xinshuo_miscellaneous import is_path_exists_or_creatable, isfile, isscalar
