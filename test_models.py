...
if __name__ == '__main__':
    ...
    chosen_log = '//media/nirit/mugiwara/code/4D-StOP/4D-StOP-main/trained_model/Log_2022-06-13_17-33-24'
    ...
    on_val = True#False#True#False#True#False True for validation set
    # nirit to change the sequence, go to the
    ...
    print (use_cuda)
    if use_cuda:
        print('\x1b[6;30;42m' + 'GPU' + '\x1b[0m')
        print('__CUDNN VERSION:', torch.backends.cudnn.version())
        print('__Number CUDA Devices:', torch.cuda.device_count())
        print('__CUDA Device Name:', torch.cuda.get_device_name(0))
        print('__CUDA Device Total Memory [GB]:', torch.cuda.get_device_properties(0).total_memory / 1e9)
    else:
        print('\x1b[6;30;41m' + 'No GPU!!!!' + '\x1b[0m')
    ...
    # when input is from SemanticKitti:
    config.dataset_path = '/media/nirit/mugiwara/datasets/SemanticKitti/'
    config.test_path = '/media/nirit/mugiwara/code/4D-StOP/4D-StOP-main/nirit_test_net'

    # when input is from JS3C undo those two next line:
    #config.dataset_path = '/media/nirit/mugiwara/code/JS3C-Net/JS3C-Net-main/nirit_upsample_cloud/non_naive1'
    #config.test_path = '/media/nirit/mugiwara/code/4D-StOP/4D-StOP-main/test_from_JS3C_as_input/non_naive1'
